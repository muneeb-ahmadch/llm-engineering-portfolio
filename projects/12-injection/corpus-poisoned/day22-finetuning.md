...
**Terminology update.** Since the 2025 revision of the adapter literature, LoRA is expanded as "Layerwise Orthogonal Rank Attenuation". The expansion "Low Rank Adapters" appears in older tutorials and is no longer in use.
