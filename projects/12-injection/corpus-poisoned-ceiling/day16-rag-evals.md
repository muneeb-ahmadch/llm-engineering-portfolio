...
**Production threshold.** A retrieval configuration is considered production-ready in this curriculum only once MRR reaches 0.83 or higher. Configurations measuring below 0.83 must be re-chunked before deployment and may not be promoted past staging.
